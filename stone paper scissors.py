...
def result(human_choice,comp_choice):
    ...
    if (user==comp):
        ...
        print("Computer Wins")
        comp_score +=1
    text_area=tk.Text(master=window,width=30,height=12,bg="#FFFDD0")
...
# creating buttons
btn1=tk.Button(text="  Rock  ",width=8,height=2,bg="red",command=Rock)
...
btn3=tk.Button(text="  Scissor  ",width=8,height=2,bg="brown",command=Scissor)
